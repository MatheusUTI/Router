...
- O Router **não** adotará Material Web por agora.
- **Material You** serve como inspiração visual de interface, não como dependência direta de pacote.
...
- **1366x768** é a resolução mínima suportada para telas de operação.
- A **Planilha Operacional** é a baseline e formato de leitura fundamental da Mesa de Roteirização.
