...
export default function RoteirizacaoHeader({
  ...
  const rightStatusClass = "font-sans bg-slate-50 dark:bg-[#070c14] rounded border border-slate-200 dark:border-[#16223f] px-2 py-1 h-8.5 flex items-center text-[11px] text-slate-550 dark:text-slate-450 leading-none shrink-0";

  return (
    <div className="bg-white dark:bg-[#0b1322] border-b border-slate-200 dark:border-[#1a2440] py-2 px-3 flex flex-col gap-2 shrink-0 select-none h-auto">
      {/* Linha 1 */}
      <div className="flex flex-wrap items-center justify-between gap-2 w-full">
        {/* Left: Brand, Plan, Filial */}
      ...
      {/* Linha 2 */}
      <div className="flex flex-wrap items-center gap-2 w-full justify-between lg:justify-start">
        {/* Unified Search Input (busca) */}
        <div className="relative w-full max-w-[280px] lg:w-64 xl:w-72 h-8.5 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {onUpdateMesaScale && (
            <div className="flex items-center gap-1 bg-slate-50 dark:bg-[#070c14] border border-slate-200 dark:border-[#1a2440] rounded px-2 h-8.5 text-[11px] select-none text-slate-500 dark:text-slate-400">
              <span className="font-mono text-[9px] text-slate-500 font-extrabold uppercase tracking-wide">Escala:</span>
              <select
                value={mesaScale}
