...
export const RoutePlanningRepository = {
  ...
  async upsertForCtrc(
    ...
    const item: RoutePlanningItem = {
      ...
      vehicleId: patch.vehicleId !== undefined ? patch.vehicleId : existing?.vehicleId,
      vehiclePlate: patch.vehiclePlate !== undefined ? patch.vehiclePlate : existing?.vehiclePlate,
      driverName: patch.driverName !== undefined ? patch.driverName : existing?.driverName,
      helperName: patch.helperName !== undefined ? patch.helperName : existing?.helperName,
